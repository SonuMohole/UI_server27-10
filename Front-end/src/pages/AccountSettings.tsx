...
const PlatformSettings = () => (
  <div className="glass-panel p-6 rounded-lg shadow-sm max-w-4xl">
    <h2 className="text-lg font-semibold mb-4">
      Platform & CVE Mapping Settings
    </h2>
    <p className="text-sm text-muted-foreground mb-4">
      Configure how your organization maps CVEs, vulnerabilities, and patch
      data.
    </p>
      ...
      <div>
        ...
        <div className="space-y-2 text-sm">
          <label className="flex items-center gap-2">
            <input type="checkbox" defaultChecked /> NVD (National
            Vulnerability Database)
          </label>
          <label className="flex items-center gap-2">
            <input type="checkbox" defaultChecked /> CISA KEV (Known Exploited
            Vulnerabilities)
          </label>
          <label className="flex items-center gap-2">
...
const Integrations = () => (
  <div className="glass-panel p-6 rounded-lg shadow-sm max-w-4xl">
    ...
    <p className="text-sm text-muted-foreground mb-4">
      Manage data collection agents and third-party threat intelligence
      integrations.
    </p>
      ...
      <div className="flex items-center justify-between mb-6 relative">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Configure your organization’s profile, CVE mapping logic, and
            security controls.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 relative" ref={dropdownRef}>
          ...
          <div
            ...
            className="w-10 h-10 rounded-full bg-gradient-to-br from-primary/20 to-secondary/30 flex items-center justify-center font-semibold text-sm cursor-pointer hover:ring-2 hover:ring-primary/30 transition-all"
          >
            JG
          </div>
          ...
          {/* Dropdown */}
          {isProfileMenuOpen && (
            <div className="absolute right-0 top-12 w-48 bg-white dark:bg-gray-900 shadow-xl rounded-md border border-border p-2 z-50 animate-fadeIn">
              <button
                onClick={() => {
                  navigate("/account_settings/account");
                  setIsProfileMenuOpen(false);
                }}
                className="flex items-center gap-2 w-full text-left text-sm px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 w-full text-left text-sm px-3 py-2 rounded-md text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition-all"
              >
